...
<input type="text" size="50" name="way" >
<font color="#999999">(введите URL файла)<br></font>
 <p><input name="picturename" maxlength="25" size="40" ><font color="#999999">(название картинки)<br></font></p>
...
<div >  Ширина:<input type="text" name="width" value=""><br>
    ...
    <div id="prew">
        ...
        <div id = 'cat3' style = 'display: none;' ><input type="text" name="textpre" value=""/><br>
            ...
            Ширина : <input type="text" name="reswidth" value=""> пропорции сохраняются <br>
